#!/usr/bin/env python3
"""
Unified HPC Network & Node Diagnostic Tool (v5.3 - Python 3.6 Legacy Compatible)
...
- Bypasses local shell variable expansion & quote breaking
...
class HPCNetworkAuditor:
    ...
    def expand_hostlist(self, raw_nodes):
        ...
        for item in raw_nodes:
            ...
            # Fallback regex range expander if scontrol is unavailable
    ...
    def audit_fabric_and_nodes(self):
        ...
        opt_script = """
        for i in $(ip -o link | awk -F': ' '{print $2}' | grep -v -E 'lo|veth|virbr'); do
            echo "===IFACE:$i==="
            ethtool "$i" 2>&1
            ethtool -m "$i" 2>&1
        done
        ...
        for node, lines in opt_data.items():
            ...
            for sec in sections[1:]:
                ...
                # Check transceiver module presence & optical power
